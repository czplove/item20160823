 ...
 * - PB1 - SC1TXD/I2C_SDA/Test Point 1
 * - PB2 - SC1RXD/I2C_SCL
 * - PB3 - NULL
 * - PB4 - Test Point 2
 * - PB5 - Red Led
 ...
 */
#define BUTTON2             PORTA_PIN(5)
/**
 * @brief The GPIO input register for BUTTON2.
 */
#define BUTTON2_IN          GPIO_PAIN
/**
 ...
 */
#define BUTTON2_SEL()       do {GPIO_IRQDSEL = PORTA_PIN(5);  } while(0)
/**
 ...
 */
  ...
  #define PWRUP_OUT_ENUMCTRL   0
  #define PWRUP_CFG_VBUSMON    GPIOCFG_IN_PUD
