 ...
 * - PA5 - TAMPTER
 * - PA6 - SC2CS
 * - PA7 - SG (IRQC Map to PA7)
 * - PB0 - Button (IRQA fixed to PB0)
 * - PB1 - SC1TXD/I2C_SDA
 * - PB2 - SC1RXD/I2C_SCL/Test Point 2
 * - PB3 - SG (IRQC Map to PA7)(not used)
 * - PB4 - NULL
 * - PB5 - Red Led
 * - PB6 - NULL
 * - PB7 - Green Led
...
enum HalBoardLedPins {
  ...
  BOARDLED1 = PORTB_PIN(5),
  BOARDLED2 = PORTA_PIN(3),
#else
...
/**
 * @brief The actual GPIO BUTTON3 is connected to.  This define should
 * be used whenever referencing BUTTON3, such as controlling if pieces
 * are compiled in.
 * Remember there may be other things that might want to use IRQD.
 */
#if defined(MOTION_SENSOR_E93196)
#define BUTTON3             PORTA_PIN(5)
/**
 * @brief The GPIO input register for BUTTON3.
 */
#define BUTTON3_IN          GPIO_PAIN
/**
 ...
 */
#define BUTTON3_SEL()       do {GPIO_IRQDSEL = PORTA_PIN(5);  } while(0)
#else
//#define BUTTON3             PORTA_PIN(4)
/**
 * @brief The GPIO input register for BUTTON3.
 */
#define BUTTON3_IN          GPIO_PAIN
 ...
 * @note IRQD is fixed and as such does not need any selection operation.
 */
#define BUTTON3_SEL()       do {GPIO_IRQDSEL = PORTA_PIN(4);  } while(0)
#endif
/**
