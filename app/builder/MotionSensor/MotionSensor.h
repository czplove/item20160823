...
#ifndef __APP_MOTIONSENSOR_H__
#define __APP_MOTIONSENSOR_H__


/**** Included Header Section ****/

/**** ZCL Section ****/
#define ZA_PROMPT "MotionSensor"
...
#define EMBER_AF_PLUGIN_TAMPER_SWITCH_TAMPER_POLARITY 1
