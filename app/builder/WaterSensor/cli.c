...
void emberAfPluginLowVoltageShutdownPrintVddCommand(void);
...
PGM_P PGM emberCommandTableZclIasZoneEnrollCommandArguments[] = {
  "zone type",
  "manufacturer code",
  NULL
};

PGM_P PGM emberCommandTableZclIasZoneScCommandArguments[] = {
  "zone status",
  "extended status",
  "zone id",
  "delay",
...
EmberCommandEntry emberCommandTableZclIasZoneCommands[] = {
...
EmberCommandEntry emberCommandTablePluginMfglibToneCommands[] = {
...
EmberCommandEntry emberCommandTablePluginMfglibStreamCommands[] = {
...
PGM_P PGM emberCommandTablePluginMfglibSendMessageCommandArguments[] = {
  "The hex data to send, up to 16 bytes.",
  "The number of packets to send.",
  NULL
};

PGM_P PGM emberCommandTablePluginMfglibSendRandomCommandArguments[] = {
  "The number of packets to send.",
  "The length of the packet to send.",
  NULL
};

PGM_P PGM emberCommandTablePluginMfglibSendTestCommandArguments[] = {
  "The number of packets to send.",
  "The length of the packet to send.",
  NULL
};

EmberCommandEntry emberCommandTablePluginMfglibSendCommands[] = {
...
PGM_P PGM emberCommandTablePluginMfglibMfgenableCommandArguments[] = {
  "1 = enable, 0 = disable.",
  NULL
};

PGM_P PGM emberCommandTablePluginMfglibProgramEuiCommandArguments[] = {
  "IEEE address to program.",
  NULL
};

PGM_P PGM emberCommandTablePluginMfglibSetChannelCommandArguments[] = {
  "The 802.15.4 channel number.",
  NULL
};

PGM_P PGM emberCommandTablePluginMfglibSetPowerCommandArguments[] = {
  "The power level",
  "The power mode",
  NULL
};

PGM_P PGM emberCommandTablePluginMfglibSleepCommandArguments[] = {
  "Sleep duration (mS).",
  NULL
};

PGM_P PGM emberCommandTablePluginMfglibStartCommandArguments[] = {
  "Use the Rx callback.",
  NULL
};

PGM_P PGM emberCommandTablePluginMfglibSynOffsetCommandArguments[] = {
  "The synth offset.",
  NULL
};

PGM_P PGM emberCommandTablePluginMfglibTestModCalCommandArguments[] = {
  "The channel to calibrate.",
  "The length of time to run the test is ms.",
  NULL
};

EmberCommandEntry emberCommandTablePluginMfglibCommands[] = {
...
PGM_P PGM emberCommandTablePluginLowVoltageShutdownEnableCommandArguments[] = {
  "The value indicating whether the shutdown logic should be disabled.",
  NULL
};

EmberCommandEntry emberCommandTablePluginLowVoltageShutdownCommands[] = {
  emberCommandEntryActionWithDetails("enable", emberAfPluginLowVoltageShutdownEnableCommand, "u", "Sets whether the plugin's check and shutdown logic is enabled or disab ...", emberCommandTablePluginLowVoltageShutdownEnableCommandArguments),
  emberCommandEntryActionWithDetails("print-vdd", emberAfPluginLowVoltageShutdownPrintVddCommand, "", "Report the current VDD voltage as checked by the shutdown logi ...", NULL),
  emberCommandEntryActionWithDetails("shutdown", emberAfPluginLowVoltageShutdownForceShutdown, "", "Force the shutdown logic to engage immediately, regardless of VDD volt ...", NULL),
  emberCommandEntryActionWithDetails("status", emberAfPluginLowVoltageShutdownStatusCommand, "", "Display the status of the check and shutdown behavior.", NULL),
  emberCommandEntryTerminator()
};
...
PGM_P PGM emberCommandTablePluginIasZoneServerChangeStatusCommandArguments[] = {
...
PGM_P PGM emberCommandTablePluginIasZoneServerInfoCommandArguments[] = {
  "The endpoint whose IAS Zone Cluster information is to be printed",
  NULL
};

EmberCommandEntry emberCommandTablePluginIasZoneServerCommands[] = {
...
PGM_P PGM emberCommandTablePluginEndDeviceSupportForceShortPollCommandArguments[] = {
  "The value indicating whether the device should short poll.",
  NULL
};

PGM_P PGM emberCommandTablePluginEndDeviceSupportPollCompletedCallbackCommandArguments[] = {
  "The value indicating whether the device's poll completed callback func ...",
  NULL
};

EmberCommandEntry emberCommandTablePluginEndDeviceSupportCommands[] = {
...
EmberCommandEntry emberCommandTablePluginConnectionManagerCommands[] = {
...
EmberCommandEntry emberCommandTablePluginCommands[] = {
  ...
  emberCommandEntrySubMenu("low-voltage-shutdown", emberCommandTablePluginLowVoltageShutdownCommands, ""),
